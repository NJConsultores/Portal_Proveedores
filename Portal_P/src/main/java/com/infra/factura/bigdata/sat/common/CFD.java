...
public interface CFD {
  ...
  void validar(InputStream inputStream, ErrorHandler handler) throws Exception;
  void validar(String xmlString, ErrorHandler handler) throws Exception;
  void verificar(ErrorHandler handler) throws Exception;
  void verificar(Certificate cert, ErrorHandler handler) throws Exception;
