...
public class TestResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the _return value for this TestResponse.
     * 
     * @return _return
     */
    ...
    /**
     * Sets the _return value for this TestResponse.
     * 
     * @param _return
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://service.ws.inter.infra.com/", "testResponse"));
