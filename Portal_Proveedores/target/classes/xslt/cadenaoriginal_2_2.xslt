...
<xsl:stylesheet version="2.0"
	...
	xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:cfd="http://www.sat.gob.mx/cfd/2"
	...
	<xsl:include
		href="/xslt/cfd/2/cadenaoriginal_2_0/utilerias.xslt" />
	<!-- En esta sección se define la inclusión de las demás plantillas de transformación 
		para la generación de las cadenas originales de los complementos fiscales -->
	<xsl:include href="/xslt/cfd/ecc/ecc.xslt" />
	<xsl:include
		href="/xslt/cfd/psgecfd/psgecfd.xslt" />
	<xsl:include
		href="/xslt/cfd/donat/donat11.xslt" />
	<xsl:include
		href="/xslt/cfd/divisas/divisas.xslt" />
	<xsl:include href="/xslt/cfd/ecb/ecb.xslt" />
	<xsl:include
		href="/xslt/cfd/detallista/detallista.xslt" />
	<xsl:include
		href="/xslt/cfd/implocal/implocal.xslt" />
	<xsl:include
		href="/xslt/cfd/terceros/terceros11.xslt" />
	<xsl:include href="/xslt/cfd/iedu/iedu.xslt" />
	<xsl:include
		href="/xslt/cfd/ventavehiculos/ventavehiculos.xslt" />
	<xsl:include href="/xslt/cfd/pfic/pfic.xslt" />
	<xsl:include
		href="/xslt/cfd/TuristaPasajeroExtranjero/TuristaPasajeroExtranjero.xslt" />
	<xsl:include
		href="/xslt/cfd/leyendasFiscales/leyendasFisc.xslt" />
	<xsl:include
		href="/xslt/cfd/psgcfdsp/psgcfdsp.xslt" />
	<!-- Aquí iniciamos el procesamiento de la cadena original con su | inicial 
		y el terminador || -->
	<xsl:template match="/">
		|
	...
	<xsl:template match="cfd:Concepto">
		...
		<!-- Manejo de los distintos sub nodos de información aduanera de forma 
			indistinta a su grado de dependencia -->
